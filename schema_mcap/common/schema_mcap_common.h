...
inline constexpr char kTransformDataTrackName[] = "frame-transform-json";
inline constexpr char kTransformSchemaName[] = "foxglove.FrameTransform";
inline constexpr char kTransformMcapChannelTopic[] = "/tf";
inline constexpr int kDefaultRecorderFrameCount = 80;
...
// Canonical Foxglove JSON schema from:
// https://github.com/foxglove/foxglove-sdk/blob/main/schemas/jsonschema/FrameTransform.json
inline constexpr char kFrameTransformJsonSchema[] = R"json({
  ...
  "properties": {
    ...
    "translation": {
      "title": "foxglove.Vector3",
      "description": "Position of the child frame origin in the parent frame.",
      "type": "object",
      "properties": {
...
inline livekit::DataTrackSchemaId frameTransformSchemaId() {
  return livekit::DataTrackSchemaId{kTransformSchemaName, livekit::DataTrackSchemaEncoding::JsonSchema};
}
