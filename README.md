...
| [`capture_source`](capture_source/) | Demonstrates SDK-owned capture sources: platform-native camera devices, plus GStreamer test-pattern and webcam pipelines, with room for additional backends. |
